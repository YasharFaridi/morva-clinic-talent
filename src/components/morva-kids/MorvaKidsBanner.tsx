...
export default function MorvaKidsBanner() {
  return (
    <section
    ...
    >
      ...
      {/* <p className="text-base md:text-lg font-light mb-6 leading-relaxed max-w-3xl mx-auto text-[var(--color-base-content)]">
        جایی که <span className="font-semibold text-[var(--color-secondary)]">خلاقیت، بازی و یادگیری</span> با هم ترکیب می‌شوند  
        تا <span className="font-semibold text-[var(--color-primary)]">استعدادهای کودکان کشف و پرورش پیدا کنند</span>.  
        بیایید با هم <span className="font-semibold text-[var(--color-warning)]">کشف کنیم، تجربه کنیم و رشد کنیم</span>! 🚀
      </p> */}
